            ...
            <div className="mb-10">
                <div className="flex items-center gap-4 mb-2">
                    ...
                    <h2 className="text-3xl font-light text-base-content">
                        {idTipo === '0' ? 'Todas las habitaciones' : tipoSeleccionado.nombre}
                    </h2>
                </div>
                <p className="text-base text-base-content/60">
                    {idTipo === '0' ? `${habitaciones.length} habitacion(es) en total` : tipoSeleccionado.descripcion || 'Sin descripción'}
                </p>
